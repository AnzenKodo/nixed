...
class Commands:
    ...
    screenshort = f'/nix/store/wc5pshsqxp1i85nc1i98fga7mha7yqfw-imagemagick-7.1.0-37/bin/import import Pictures/Screenshots/screenshort.png'
    screenshortFull = f'/nix/store/wc5pshsqxp1i85nc1i98fga7mha7yqfw-imagemagick-7.1.0-37/bin/import -window root "Pictures/Screenshots/screenshotFull.png"'
