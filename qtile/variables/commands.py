...
class Commands:
    ...
    screenshort = 'fish -c "import ~/Pictures/Screenshorts/(date "+%d-%m-%Y-%H:%M:%S").png"'
    screenshortFull = 'fish -c "import -window root ~/Pictures/Screenshorts/(date "+%d-%m-%Y-%H:%M:%S").png"'
